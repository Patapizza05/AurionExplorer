...
public class HamburgerMenuManager {
    ...
    private String[] titles = {"Mes Notes", "Mes Absences", "Mon Planning",null,"Mes Conférences", null,"Annuaire des Étudiants","Annuaire du Staff","Anniversaire",null,"Fortinet"};
